...
const images = [
  {
    image: new URL(
      "@/assets/image/Product/Product-buy/product-knife1.png",
      import.meta.url
    ).href,
  },
  {
    image: new URL(
      "@/assets/image/Product/Product-buy/product-knife2.png",
      import.meta.url
    ).href,
  },
  {
    image: new URL(
      "@/assets/image/Product/Product-buy/product-knife3.png",
      import.meta.url
    ).href,
  },
];
...
<template>
  <div class="product-container">
    ...
    <div class="back-col">
      <button class="back-button" @click="goBack">
        <span class="arrow"
          ><img src="/src/assets/image/Product/recall.png"
        /></span>
        回前頁
      </button>
    </div>
    ...
    <div class="product-gallery">
      ...
      >
        <SwiperSlide v-for="(img, i) in images" :key="i">
          <img :src="img.image" class="main-image" :alt="`商品主圖 ${i + 1}`" />
        </SwiperSlide>
      </Swiper>
      ...
      >
        <SwiperSlide v-for="(img, i) in images" :key="i">
          <img :src="img.image" class="thumb-image" :alt="`縮圖 ${i + 1}`" />
        </SwiperSlide>
    ...
    <aside class="card">
      ...
      <button class="btn primary" @click="addToCart">
        <Icon icon-name="order" class="icon-cart" />
        加入購物車
      </button>
      <p class="note">
        若商品缺貨可以先加入「願望清單」。
      ...
      <button class="btn ghost" @click="toggleWishlist">
        <template v-if="inWishlist">
          <Icon icon-name="heart" class="icon-heart" />
          已加入願望清單
        </template>
        <template v-else>
          <Icon icon-name="heartL" class="icon-heart" />
          加入願望清單
        </template>
      </button>
    </aside>
    ...
    <div class="notice-wrap">
      <section class="product-notice">
        ...
        <ul>
          ...
          <li>
            -請勿用於切割堅硬食材或作為其他工具使用， 以免損壞產品或造成危險。
          </li>
        </ul>
  ...
  <section class="related-section">
    ...
    >
      <SwiperSlide v-for="(p, i) in products" :key="i">
        <div class="related-card">
          <img :src="p.image" class="related-img" />
