    ...
    <div class="main-footer__container container-large">
      <div class="main-footer__header">
        <h2 class="main-footer__title">
          不是專業廚師也沒關係
          <span class="main-footer__title-second">讓人「好想吃一口」就夠了</span>
        </h2>
      </div>
    ...
    <div class="main-footer__vegetables">
      <ul class="main-footer__vegetables-list">
        <li class="main-footer__vegetables-item">
          <div class="main-footer__vegetables-pic">
            <img
              src="@/assets/image/footer/01.png"
              alt=""
              class="main-footer__vegetables-img"
            />
          </div>
        </li>
        <li class="main-footer__vegetables-item">
          <div class="main-footer__vegetables-pic">
            <img
              src="@/assets/image/footer/02.png"
              alt=""
              class="main-footer__vegetables-img"
            />
          </div>
        ...
        <li class="main-footer__vegetables-item">
          <div class="main-footer__vegetables-pic">
            <img
              src="@/assets/image/footer/05.png"
              alt=""
              class="main-footer__vegetables-img"
            />
          </div>
        ...
        <li class="main-footer__vegetables-item">
          <div class="main-footer__vegetables-pic">
            <img
              src="@/assets/image/footer/06.png"
              alt=""
              class="main-footer__vegetables-img"
            />
          </div>
