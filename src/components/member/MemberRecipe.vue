  ...
  <div class="recipe-management">
    ...
    <div class="recipe-management__section">
      ...
      >
        ...
        <Icon 
          icon-name="upA" 
          :class="['recipe-management__toggle-icon', { 'recipe-management__toggle-icon--expanded': isDraftExpanded }]"
        />
      </button>

      <div v-if="isDraftExpanded" class="recipe-management__draft-card">
